...
#os.system('gsettings set org.gnome.desktop.background picture-uri ' + picture_path)
import subprocess
#picture_path='/home/MIQDIGITAL/ashutosh/mediaiq_codes/secrets_pems/Bing/'+cd+'.jpg'
picture_path=os.path.join('Bing',cd+'.jpg')
#TO CHANGE WALLPAPER
picture_path='/home/sahana.mohandoss/training/flask-intro/intern-python-codes/Bing/'+ cd+'.jpg'
