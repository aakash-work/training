...
print(picture_path)
os.system("/usr/bin/gsettings set org.gnome.desktop.background picture-uri file:/home/rati.ranjan/training/pythonSess/flask-intro/intern-python-codes/%s"%picture_path)
